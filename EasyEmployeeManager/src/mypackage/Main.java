...
public class Main {
	...
	{
		System.out.println();
		System.out.printf("%-25s%-25s%-25s%-25s%-25s%-25s%-25s","ID " ," First Name  " , " Last Name " , " Email Address " , " Position " , " Location", "Current Employee");
		System.out.println();
		try 
		{
	...
	public void insertData() 
	{
		...
		try 
		{
			...
			pw.append(epmployeeID + "," + epmployeeFN + "," +epmployeeLN + "," + email+ "," +epmployeePosition + "," + epmployeeLocation + "," + employementStatus +"\n");
			pw.close();
		}catch(Exception e) 
		{
	...
	public void update() 
	{
		...
		String ColumnsToChange[] = {"First Name:  " , "Last Name: " , "Email" , "Position: ","Location: " , "Employment Status: "};
